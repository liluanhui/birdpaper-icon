...
export const donateLocales: Record<"zh-CN" | "en", DonateLocale> = {
  "zh-CN": {
    ...
    brand: "Birdpaper Icon",
    headline: "如果你觉得有帮助，欢迎支持一下",
    lead: "Birdpaper Icon 持续维护依赖社区与个人投入。你可以通过作者主页了解更多，或前往赞助页直接支持项目推进。",
    siteLabel: "作者主页",
    siteTitle: "了解作者与作品",
    ...
    sponsorLabel: "赞助支持",
    sponsorTitle: "前往赞助页",
    sponsorDesc: "通过赞助支持开源维护，让 Birdpaper Icon 走得更远、更稳。",
    sponsorCta: "去赞助",
    thanks: "感谢每一位使用者与贡献者。",
  },
  en: {
    ...
    lead: "Birdpaper Icon is maintained with community help and personal effort. Visit the author’s site to learn more, or go to the sponsor page to support ongoing work.",
    siteLabel: "Author",
    ...
    sponsorDesc: "Sponsor open-source maintenance so Birdpaper Icon can keep improving.",
